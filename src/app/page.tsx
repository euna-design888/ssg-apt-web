...
import CheongyakScoreCalculator from '@/components/CheongyakScoreCalculator';
...
export default function HomePage() {
  const [viewMode, setViewMode] = useState<'feed' | 'calendar' | 'calculator'>('feed');
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#f8f9fa' }}>
      ...
      <main className="container" style={{ flex: 1 }}>
        ...
        {/* 3. 뷰 모드 스위치 (피드 vs 캘린더 vs 가점 계산기) */}
        <div className="view-mode-switch">
          ...
          <button
            type="button"
            className={`view-switch-btn ${viewMode === 'calculator' ? 'active' : ''}`}
        ...
        {viewMode === 'feed' ? (
          ...
          /* 4-4. 정밀 84점 청약 가점 진단기 뷰 */
          <div style={{ marginBottom: '32px' }}>
            <CheongyakScoreCalculator apartments={apartments} />
          </div>
        )}
      </main>
